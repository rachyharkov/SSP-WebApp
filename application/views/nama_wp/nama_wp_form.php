...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Npwp Wp <?php echo form_error('npwp_wp') ?></td><td><input type="text" class="form-control" name="npwp_wp" id="npwp_wp" placeholder="Npwp Wp" value="<?php echo $npwp_wp; ?>" maxlength="15" /></td></tr>
